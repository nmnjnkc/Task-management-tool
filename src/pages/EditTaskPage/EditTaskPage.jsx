...
const EditTaskPage = () => {
  ...
  const { setTaskUpdate, employees, tasks, theTaskDifficulty, theTaskStatus } =
  ...
  function submitForm(event) {
    ...
    fetch(
      `https://640b1ad481d8a32198d9d28b.mockapi.io/Tasks/${currentTask.id}`,
      {
        method: "PUT",
        headers: {
    ...
    <div className="editForm">
      {!showError && (
        <form className="form" onSubmit={submitForm}>
          ...
          <TheDatePicker
            label={"Edit date the task was asigned on:"}
